...
class ComplexTableField extends TableListField {
	...
	public function FieldHolder($properties = array()) {
		...
		Requirements::javascript("legacytablefields/javascript/ComplexTableField.js");
		Requirements::css(THIRDPARTY_DIR . "/greybox/greybox.css");
		Requirements::css("legacytablefields/css/TableListField.css");
		Requirements::css("legacytablefields/css/ComplexTableField.css");
...
class ComplexTableField_Popup extends Form {
	...
	public function forTemplate() {
		...
		Requirements::css('legacytablefields/css/ComplexTableField_popup.css');
		...
		Requirements::javascript("legacytablefields/thirdparty/scriptaculous/scriptaculous.js");
		Requirements::javascript("legacytablefields/thirdparty/scriptaculous/scriptaculous/controls.js");
		Requirements::add_i18n_javascript(FRAMEWORK_DIR . '/javascript/lang');
		Requirements::javascript("legacytablefields/javascript/ComplexTableField_popup.js");
