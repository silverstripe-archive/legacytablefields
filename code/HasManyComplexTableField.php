...
class HasManyComplexTableField extends ComplexTableField {
	...
	public function FieldHolder($properties = array()) {
		...
		Requirements::javascript("legacytablefields/javascript/HasManyFileField.js");
		Requirements::javascript('legacytablefields/javascript/RelationComplexTableField.js');
		Requirements::css('legacytablefields/css/HasManyFileField.css');
